...
module my_addr::food {
    ...
    public fun food_token_address(food_token_name: String): address {
        token::create_token_address(&@my_addr, &string::utf8(FOOD_COLLECTION_NAME), &food_token_name)
    }
    ...
    #[test(creator = @my_addr, user1 = @0x456, user2 = @0x789)]
    public fun test_food(creator: &signer, user1: &signer, user2: &signer) acquires FoodToken {
        ...
        assert!(signer::address_of(creator) == @my_addr, 0);
